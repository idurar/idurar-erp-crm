...
router
  .route("/paymentInvoice/create")
  .post(catchErrors(paymentInvoiceController.create));
router
  .route("/paymentInvoice/read/:id")
  .get(catchErrors(paymentInvoiceController.read));
router
  .route("/paymentInvoice/update/:id")
  .patch(catchErrors(paymentInvoiceController.update));
router
  .route("/paymentInvoice/delete/:id")
  .delete(catchErrors(paymentInvoiceController.delete));
router
  .route("/paymentInvoice/search")
  .get(catchErrors(paymentInvoiceController.search));
router
  .route("/paymentInvoice/list")
  .get(catchErrors(paymentInvoiceController.list));
router
  .route("/paymentInvoice/filter")
  .get(catchErrors(paymentInvoiceController.filter));
router
  .route("/paymentInvoice/pdf/:id")
  .get(catchErrors(paymentInvoiceController.generatePDF));
