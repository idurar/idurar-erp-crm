    ...
    <div style={{ padding: '24px' }}>
      <div style={{ marginBottom: '24px' }}>
        <h1 style={{ 
          ...
          <EditOutlined />
          {translate('update_proforma_invoice') || 'Update Proforma Invoice'}
        </h1>
        <p style={{ 
          margin: '8px 0 0 0', 
          color: '#6b7280',
          ...
          {translate('update_proforma_invoice_description') || 'Update the proforma invoice details'}
        </p>
      </div>
      ...
      >
        <UpdateQuoteModule config={configPage} />
      </Card>
    </div>
  );
}